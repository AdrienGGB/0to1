...
BEGIN
  ...
  INSERT INTO courses (title, description, topic, level, ai_prompt, generated_by)
  VALUES (course_title, course_description, course_topic, course_level, course_ai_prompt, 'ai')
